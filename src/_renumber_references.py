...
def main() -> None:
    paper_path = Path(r"c:\Users\Administrator\Desktop\小论文2\FEA\paper_final.md")
    ...
    refs = [
        ...
        "[3] Kocaöz S, Gördeles Beşer N, Kizilirmak A. Striae gravidarum in primigravid women: prevalence, risk factors, prevention interventions and body image. J Matern Fetal Neonatal Med. 2019. doi:10.1080/14767058.2019.1591363",
        ...
        "[9] Boyer G, Lachmann N, Bellemère G, De Belilovsky C, Baudouin C. Effects of pregnancy on skin properties: a biomechanical approach. Skin Res Technol. 2018. doi:10.1111/srt.12465",
